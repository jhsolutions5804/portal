...
> 최초 작성: 2026-07-01 · 최종 개정: 2026-09-24 (r6 · 업무일지 캘린더 뷰 신설, 상세화면 복귀처 수정) · 2026-09-16 (r5 · 연차신청서 결재라인(approvers) 추가, 관리자 결재함 전체조회) · 2026-09-16 (r4 · 연차신청서 관리자 전 직원 신청 내역 조회 기능 추가) · 2026-09-16 (r3 · 결재 처리 후 결재요청(결재함)으로 복귀) · 2026-08-29 (r2 · 업무일지 권한오류 수정, 연차신청서 전면 개편) -20 (r1 · 업무일지 임시저장/반려 상태 수정 기능) · 작성: 춘식이(Claude)
