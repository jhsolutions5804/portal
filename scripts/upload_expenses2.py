...
EXPENSES = [
    ...
    # ── 신규 7건 (거래명세표 / 외상) ───────────────────────────────────────
    {"date":"2026-06-01","cat":"공구·자재비","vendor":"거상주식회사(평택지점)","supply":52000,"vat":5200,"total":57200,"pay":"외상","pjt":"p4ph2","note":"안전모(악세사리)470패센텍x10, 코메론 고무피복줄자(KMC-25RJ 7.5M×25)x1, 볼토시K2(검정.그레이.백색)x1, 멀티스카프 롤/K2(하이크넥스카프(IUA21910))x1, 각반(일반)(청색프라이드(일반))x5"},
    {"date":"2026-06-08","cat":"공구·자재비","vendor":"넘바원상사(주)","supply":524600,"vat":52460,"total":577060,"pay":"외상","pjt":"p4ph2","note":"절연발등안전화 SMN-P608C x9, 가족제안전화 HBS-480A<240>x1, 제전가방/(400×450)x9"},
    {"date":"2026-06-09","cat":"공구·자재비","vendor":"넘바원상사(주)","supply":12000,"vat":1200,"total":13200,"pay":"외상","pjt":"p4ph2","note":"기술인조끼(연두 고휘도반사띠)하늘색 x1"},
    {"date":"2026-06-10","cat":"공구·자재비","vendor":"넘바원상사(주)","supply":230000,"vat":23000,"total":253000,"pay":"외상","pjt":"p4ph2","note":"안전벨트전체식포이더볼(HMT-02P,해밀턱) x5"},
